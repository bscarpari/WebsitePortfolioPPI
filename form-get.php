...
<head>
    ...
    <title>Dados: Contato (via GET)</title>
</head>
<body class="<?php echo isset($_COOKIE['theme']) ? $_COOKIE['theme'] : 'dark'; ?>">
        ...
        <main class="div-align">
            <table class="table">
                ...
                if (isset($_GET['submit'])) {
                    ...
                    echo "<tr><th>Nome do cliente</th><th>E-mail</th><th>Assunto</th></tr>";
                    echo "<tr><td>$nome</td><td>$email</td><td>$assunto</td></tr>";
    ...
    <footer class="footer">
        <div class="social-icons">
            ...
            <a href="https://www.linkedin.com/in/brunoscarpari/" target="_blank"><i class="fab fa-linkedin-in" target="_blank"></i></a>
